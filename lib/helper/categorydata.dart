...
List<CategoryModel> getCategories () {
  ...
  category.categorytName = "Entertainment";
  ...
  category.categorytName = "Business";
  ...
  category = new CategoryModel();
  category.categorytName = "General";
  ...
  category = new CategoryModel();
  category.categorytName = "Science";
